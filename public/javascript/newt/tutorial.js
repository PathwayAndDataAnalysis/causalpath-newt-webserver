...
tutorial.introduction = function (checkCookie) {
	...
	intro.setOptions({
		steps: [
			{
				intro: '<h2 style="text-align:center; margin-top: 10px;"><b style="vertical-align:middle; color:#0B9BCD;">Welcome to  </b><img src="img/newt-logo.png"> </h2>\n\
...
function setStyleDuringIntroduction(intro, isChecked) {
	...
	var buttonLayer = document.getElementsByClassName(
	...
	if (showWarning) {
		...
		cookieWarningDiv.innerHTML =
			'<p style="font-size:11px; margin: 15px 0px 0px 0px; float:left;">\n\
...
setStyleRule = function (selector, rule) {
	...
	for (var i in document.styleSheets) {
		if (
			...
			document.styleSheets[i].href.indexOf('introjs.css')
		) {
