...
module.exports = function () {
    ...
    mapTabLabelPanel = appUtilities.mapTabLabelPanel = new BackboneViews.MapTabLabelPanel({
    ...
    fontPropertiesView = appUtilities.fontPropertiesView = new BackboneViews.FontPropertiesView({
    ...
    function toolbarButtonsAndMenu() {
        ...
        $('#sif-file-input').change(function () {
            ...
            if ($(this).val() !== '') {
                ...
                if (cy.elements().length !== 0) promptConfirmationView.render(loadFcn);
                else loadFcn();
        ...
        $(document).on('sbgnvizLoadFileEnd sbgnvizLoadSampleEnd', function (evt, filename, cy) {
            ...
            if (!currentGeneralProperties.mapPD2AFConverted) {
                // if the file don't have a specified map name from pd map to af map conversion
            ...
            // init map properties
            var mapProperties =
                properties && properties.mapProperties ? properties.mapProperties : {};
            ...
            if (mapPropertiesExist) {
                ...
                if (currentGeneralProperties.mapColorSchemeStyle == 'solid') {
                    for (var nodeClass in appUtilities.mapColorSchemes[
                        ...
                        classBgColor =
                            appUtilities.mapColorSchemes[currentGeneralProperties.mapColorScheme][
                                'values'
                                ][nodeClass];
                    ...
                    for (var nodeClass in appUtilities.mapColorSchemes[
                        ...
                        classBgImg =
                            currentGeneralProperties.mapColorSchemeStyle == 'gradient'
        ...
        $('#resize-nodes-to-content').click(function (e) {
            ...
            var toBeResized = cy
                .nodes()
                .difference(
                    'node[class*="process"],[class*="association"],[class*="dissociation"],[class="empty set"],[class="and"],[class="or"],[class="not"],[class="delay"],:parent'
                );
        ...
        $('#highlight-errors-of-pd2af').click(function (e) {
            ...
            var properties = appUtilities.getScratch(
                appUtilities.getActiveCy(),
                'currentGeneralProperties'
            );

            var file = chiseInstance
                .getSbgnvizInstance()
                .convertSbgn(filename, 'plain', renderInfo, properties, nodes, edges, true);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.name === 'Error' || data.error || data.name === 'error') {
                        ...
                        // Create new network
                        var current = appUtilities.getScratch(
                            appUtilities.getActiveCy(),
                            'currentGeneralProperties'
                        );
        ...
        $('#highlight-errors-of-validation, #highlight-errors-of-validation-icon').click(function (
            e
        ) {
        ...
        $('#toggle-grid-snapping-icon').click(function () {
            ...
            var toggleShowGridEnableSnap =
                appUtilities.getScratch(cy, 'toggleShowGridEnableSnap') || false;
        ...
        $('#toggle-guidelines-snapping-icon').click(function () {
            ...
            var toggleEnableGuidelineAndSnap =
                appUtilities.getScratch(cy, 'toggleEnableGuidelineAndSnap') || false;
