    ...
    sifStyle.apply = function (formatText) {
        ...
        lines.forEach(function (line) {
            ...
            if (nameMapping[eleType][featureName]) {
                ...
                var bgColor = sanitizeFeatureVal(
                    'background-color',
                    infoboxFeatures[2]
                );
                var borderColor = sanitizeFeatureVal(
                    'border-color',
                    infoboxFeatures[3]
                );
                ...
                selectedEles.forEach(function (ele) {
                    ...
                    var index =
                        ele.data('statesandinfos').length +
                        sifStyle.getNewInfoboxCount(ele);
                    ...
                    var obj = appUtilities.getDefaultEmptyInfoboxObj(
                        'unit of information'
                    );
