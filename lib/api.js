...
function analyzeFiles(room) {
    let cmdFindParameters = "find ./analysisOut/" + room + ' -name "parameters.txt"';
    let cmdFindSif = "find ./analysisOut/" + room + ' -name "*.sif"'; 
    let cmdFindInvalid = "find ./analysisOut/" + room + ' -name "invalid*"'; 
    ...
    try {
        ...
        new Promise(function (resolve, reject) {
            ...
            .then((content) => {
                ...
                let cmdDeleteRoom = "rm -rf ./analysisOut/" + room;
